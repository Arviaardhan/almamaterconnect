...
const mockUsers: Record<number, {
  ...
  2: { id: 2, name: "Siti Nurhaliza", initials: "SN", institution: "ITB", major: "Design", bio: "UI/UX designer who transforms complex problems into elegant, user-centered solutions. Figma advocate and design system enthusiast.", skills: ["Figma", "UI/UX", "Flutter", "Adobe XD", "Prototyping"], teamsJoined: 3, projectsCompleted: 5, github: "https://github.com", linkedin: "https://linkedin.com", phone: "6281234567891", email: "siti.nurhaliza@itb.ac.id", teams: [{ name: "Design Sprint Jakarta", role: "Lead Designer", status: "Active" }, { name: "Mobile App Challenge", role: "UI Designer", status: "Completed" }], projects: [{ name: "HealthTrack Redesign", description: "Complete UX overhaul for a health monitoring application." }, { name: "Campus Navigator", description: "Wayfinding app design for ITB campus." }] },
  ...
  8: { id: 8, name: "Citra Dewi", initials: "CD", institution: "ITB", major: "Design", bio: "Visual storyteller and interaction designer. Specializes in design systems and accessibility.", skills: ["Figma", "UI/UX", "React", "Accessibility", "Motion Design"], teamsJoined: 2, projectsCompleted: 3, github: "https://github.com", linkedin: null, phone: "6281234567897", email: "citra.dewi@itb.ac.id", teams: [{ name: "Design Systems Jam", role: "Lead Designer", status: "Active" }], projects: [{ name: "AccessiLearn", description: "Accessible e-learning platform for visually impaired students." }] },
};
